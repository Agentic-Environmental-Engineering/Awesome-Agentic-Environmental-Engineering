...
This file mirrors the README paper-list sections from Environment Domain onward. Each entry is copied from the original public reference list; titles, authors, venues, years, and links are intentionally left unchanged.
